...
const API_NAMES = new Set([
  ...
  "volume_profile", "cvd", "cvd_divergence", "markov", "opening_range", "prev_day_range",
  "signal", "risk", "stop_mult", "target_rr", "scale_at", "scale_frac", "scale_be",
  "trail_dist", "isnan", "nan", "i", "n",
  "hour", "minute", "dow",
...
const CHEATSHEET: { group: string; items: [string, string][] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      ["cvd_divergence(p)", "+1 bullish / -1 bearish / 0 CVD divergence"],
      ["opening_range(h,m,dur)", "→ (high, low, mid, width) today's OR"],
      ["prev_day_range()", "→ (high, low, close) prior session"],
  ...
  },
  {
    ...
    items: [
      ...
      ["trail_dist = 1.5*atr(14)", "trail the runner's stop by this price distance"],
